...
class PerfilComponent extends Component {
    ...
    editarPerfil = async () => {
        ...
        AppServices.updateUser(user,id).then((res) =>{
            if(res.status === 200){
        ...
        return (
            <>
                <Modal className='modal modal-lg' show={this.state.showModal} onHide={this.handleClose} dialogClassName="custom-modal">
                        ...
                        <img src={imgPerfil} className="img-thumbnail" alt="..." width="200" height="200" style={{ borderRadius: "50%", margin: "auto" }}></img>
                        </div>
                        <div className="form-group">
                        <label>Alterar foto de perfil</label><br/>
                        <input type="file" className="form-control-file" onChange={this.changeImgPerfilHandler}/>
                        </div>
                        <br/><br/><br/>
